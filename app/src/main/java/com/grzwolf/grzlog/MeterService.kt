...
class MeterService : Service() {
    ...
    private fun startService() {
        ...
        Toast.makeText(this, "GrzLog Meter Service starting", Toast.LENGTH_SHORT).show()
        ...
        wakeLock =
            (getSystemService(Context.POWER_SERVICE) as PowerManager).run {
                newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "MeterService::lock").apply {
                    acquire()
                }
            }

        // run GrzLog Meter silently
        SettingsActivity.generateMeterSilent()
    }
    ...
    private fun createNotification(): Notification {
        val notificationChannelId = "Meter SERVICE CHANNEL"

        val notificationManager = getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager;
        val channel = NotificationChannel(
            notificationChannelId,
            "GrzLog Upload Meter Service",
            NotificationManager.IMPORTANCE_HIGH
        ).let {
            it.description = "GrzLog Upload Meter Service channel"
        ...
        return builder
            .setContentTitle("GrzLog Upload Meter Service")
